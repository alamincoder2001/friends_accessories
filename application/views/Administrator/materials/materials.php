            ...
            <form id="materialForm" class="form-horizontal" v-on:submit.prevent="saveMaterial">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="code" id="code" v-model="material.code" class="form-control" placeholder="Material Id" disabled="disabled">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <label class="control-label col-sm-1"> : </label>
                        <div class="col-sm-6">
                            <input type="text" name="name" id="name" v-model="material.name" class="form-control" placeholder="Material Name" required>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <label class="control-label col-sm-1"> : </label>
                        <div class="col-sm-6">
                            <input type="text" name="reorder_level" id="reorder_level" v-model="material.reorder_level" class="form-control" placeholder="Re-Order Level">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <label class="control-label col-sm-1"> : </label>
                        <div class="col-sm-6">
                            <input type="text" name="purchase_rate" id="purchase_rate" v-model="material.purchase_rate" class="form-control" placeholder="Purchase Rate" required>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <label class="control-label col-sm-1"> : </label>
                        <div class="col-sm-6">
                            <v-select label="Unit_Name" v-bind:options="units" v-model="selectedUnit" placeholder="Select Unit"></v-select>
                        </div>
                    </div>
