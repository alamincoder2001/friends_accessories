...
<div id="quotation" class="row">
	<div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
		<div class="row">
			...
			<div class="form-group">
				<label class="col-md-1 col-xs-4 control-label no-padding-right"> Qu. From </label>
				<div class="col-md-2 col-xs-8">
								...
								<table style="color:#000;margin-bottom: 0px;border-collapse: collapse;">
									...
									<tr>
										<td>
											<div class="form-group">
												<div class="col-xs-4">
													<input type="button" style="font-size:12px;" class="btn btn-default" value="Save" v-on:click="saveQuotation" style="color:#fff;margin-top: 0px;">
												</div>
												<div class="col-xs-6">
													<input type="button" style="font-size:12px;" class="btn btn-info" value="New Quotation" v-on:click="window.location = '/quotation'" style="color:#fff;margin-top: 0px;">
												</div>
											</div>
										</td>
									</tr>
