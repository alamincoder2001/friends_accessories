		...
		<div class="row" style="margin-top: 10px;margin-bottom:15px;border-bottom: 1px solid #ccc;padding-bottom:15px;">
			<div class="col-md-5">
				...
				<div class="form-group clearfix">
					...
					<div class="col-md-7">
						<v-select v-bind:options="companies" v-model="selectedCompany" label="display_name"></v-select>
					</div>
	...
	new Vue({
		...
		methods: {
			...
			saveCustomer() {
				...
				this.customer.Company_Id = this.selectedCompany.Company_SlNo;
			...
			editCustomer(customer) {
				...
				this.selectedCompany = {
					Company_SlNo: customer.Company_Id,
					display_name: `${customer.Company_Code} - ${customer.Company_Name} - ${customer.Company_Mobile}`
				}
