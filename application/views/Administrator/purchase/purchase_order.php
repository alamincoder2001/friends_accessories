						...
						<div class="col-xs-12 col-md-6">
							<form v-on:submit.prevent="addToCart">
								...
								<div class="form-group">
									...
									<div class="col-xs-3">
										<input type="text" min="0" step="0.01" id="quantity" name="quantity" class="form-control" placeholder="Quantity" ref="quantity" v-model="selectedProduct.quantity" v-on:input="productTotal" required />
									</div>
								</div>
										...
										<td>
											<div class="form-group">
												...
												<div class="col-xs-6 no-padding-right">
													<input type="number" id="vat" class="form-control" name="vat" v-model="purchase.vat" readonly />
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										<td>
											<div class="form-group">
												...
												<label class="col-xs-6 control-label no-padding-right">Prev. Due</label>
											</div>
										</td>
									</tr>
