        ...
        <div class="col-xs-12 col-md-12 col-lg-12" style="border-bottom:1px #ccc solid;margin-bottom:5px;">
            <div class="row">
                <div class="form-group">
                    <label class="col-xs-4 col-md-1 control-label no-padding-right" for="age"> Invoice no </label>
                ...
                <div class="widget-body">
                    <div class="widget-main">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-md-6">
                                <div class="form-group">
                                    <label class="col-xs-4 control-label no-padding-right" for="patient_id"> Raw Material
                                    </label>
                                    <div class="col-xs-7">
                                ...
                                <form id="MaterialsResult" v-on:submit.prevent="addToCart">
                                    <div class="form-group">
                                        <label class="col-xs-4 control-label no-padding-right" for="materialName">
                                            Material Name
                                        </label>
                                        <div class="col-xs-8">
                                    ...
                                    <div class="form-group">
                                        <label class="col-xs-4 control-label no-padding-right" for="totalAmount"> Total
                                            Amount </label>
                                        <div class="col-xs-8">
                                ...
                                <div class="table-responsive">
                                    <table class="" cellspacing="0" cellpadding="0" style="color:#000;margin-bottom: 0px;">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <label class="col-xs-12 control-label" for="subTotalDisabled"> Vat </label>
                                                    <div class="col-xs-5 no-padding-right">
                                                        <input type="number" class="form-control" id="vatPersent" name="vatPersent" v-model="vatPercent" v-on:input="calculateTotal" />
                                                    </div>
                                                    <label class="col-xs-1 no-padding-left"> % </label>
                                                    <div class="col-xs-5 no-padding">
                                                        <input type="number" class="form-control" id="purchVat" readonly="" name="purchVat" v-model="purchase.vat" />
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <label class="col-xs-12 control-label no-padding-right" for="previousDue">Previous Due</label>
                                                    <div class="col-xs-12">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <label class="col-xs-12 control-label no-padding-right" for="subTotalDisabled">Due</label>
                                                    <div class="col-xs-12">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="form-group">
                                                    <div class="col-xs-5">
                                                        <input type="button" class="btn btn-success" value="Purchase" style="background:#000;color:#fff;font-size:12px;" v-on:click="savePurchase" v-bind:disabled="purchaseInProgress ? true : false">
                                                    </div>
                                                    <div class="col-xs-5">
                                                        <a class="btn btn-info" href="<?php echo base_url(); ?>material_purchase" style="background:#000;color:#fff;font-size:12px;">NewPurchase</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
